        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <h6>Lưu ý: 
                        <br>
                        * Bỏ ảnh cần thêm vào trong thư mục admin/product/uploads <br>* Sau khi sửa bạn cần thao tác lại upload ảnh</h6>
                    <div class="form-group">
                    ...
                    <a class="nav-link" href="./add_6_thumbnail.php">Thêm thumbnail?</a>
                    <div class="form-group">
